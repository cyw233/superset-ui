 ...
 * under the License.
 */
import { GenerationByTechnologyChartPlugin } from '../src';
 ...
 */
describe('@superset-ui/plugin-chart-generation-by-technology', () => {
  it('exists', () => {
    expect(GenerationByTechnologyChartPlugin).toBeDefined();
  });
});
