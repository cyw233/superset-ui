...
type GenerationTechWaterfallDatum = DataRecord;
...
export default function transformProps(chartProps: ChartProps) {
   ...
   * can also be accessed from your GenerationTechWaterfall.tsx file, but
  ...
  const data = queryData.data as GenerationTechWaterfallDatum[];
