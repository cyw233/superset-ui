 ...
 * under the License.
 */
import { GenerationTechWaterfallChartPlugin } from '../src';
 ...
 */
describe('@superset-ui/plugin-chart-generation-tech-waterfall', () => {
  it('exists', () => {
    expect(GenerationTechWaterfallChartPlugin).toBeDefined();
  });
});
