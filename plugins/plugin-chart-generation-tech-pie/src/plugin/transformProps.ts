...
type GenerationTechPieDatum = DataRecord;
...
export default function transformProps(chartProps: ChartProps) {
   ...
   * can also be accessed from your GenerationTechPie.tsx file, but
  ...
  const data = queryData.data as GenerationTechPieDatum[];
